...
1 Use the setup file to install CvvCoin GUI Wallet

2 Default Location of CvvCoin's root Directory in Windows is:
    
    32-bit: Program Files/CvvCoin
    64-bit: Program Files (x86)/CvvCoin

3 Go to CvvCoin's root directory and run CvvCoin-qt.exe

4 Data Directory is located at: Users/your_windows_user/AppData/Roaming/CvvCoin
