...
--Updated 4/5/2014 by CvvCoinDevs--
--fixed QT source Links--
--Updated to CvvCoin Folders--
--updated links to boost 1_55_0
--Added FAQ--



<img src="http://Cvvcoin.com/splash.png" alt="CvvCoin">
...
Once you've got the right hardware and software:
    ...
    https://github.com/CvvCoinCoin/Cvvcoin.git
    ...
    cd ../gitian-builder
    git pull
    sudo ./bin/gbuild --commit CvvCoin=HEAD ../CvvCoin/contrib/gitian-descriptors/gitian.yml

    # Build Win32 dependencies: (only needs to be done once, or when dependency versions change)
    sudo ./bin/gbuild --commit CvvCoin=HEAD ../CvvCoin/contrib/gitian-descriptors/boost-win32.yml
    sudo ./bin/gbuild --commit CvvCoin=HEAD ../CvvCoin/contrib/gitian-descriptors/deps-win32.yml
    sudo ./bin/gbuild --commit CvvCoin=HEAD ../CvvCoin/contrib/gitian-descriptors/qt-win32.yml

    # Build Win32 release:
    sudo ./bin/gbuild --commit CvvCoin=HEAD ../CvvCoin/contrib/gitian-descriptors/gitian-win32.yml
...
If you need more help please visit CvvCoin Forum at www.CvvCoin.rocks
